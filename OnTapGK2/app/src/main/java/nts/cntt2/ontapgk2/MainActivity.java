...
public class MainActivity extends AppCompatActivity {
    ...
    public void ChuyenBMI (View v) {
        //Tạo một đối tượng Intent
        //Tham số thứ 2 của ham tạo này, là tên Activity ( màn hình ) ta muốn chuyển sang
        Intent iManHinhKhac = new Intent(this, ActivityBMI.class);
        //Thuc hien chuyen
        startActivity(iManHinhKhac);
    }
    // Hàm đáp ứng sự kiện nấn lên nút "Sang màn hình khác"
    // Xử lý chuyển màn hình
    public void ChuyenMonAn (View v) {
        //Tạo một đối tượng Intent
        //Tham số thứ 2 của ham tạo này, là tên Activity ( màn hình ) ta muốn chuyển sang
        Intent iManHinhKhac = new Intent(this, ActivityMonAn.class);
        //Thuc hien chuyen
        startActivity(iManHinhKhac);
    }
    public void ChuyenBaiThuoc (View v) {
        //Tạo một đối tượng Intent
        //Tham số thứ 2 của ham tạo này, là tên Activity ( màn hình ) ta muốn chuyển sang
        Intent iManHinhKhac = new Intent(this, ActivityBaiThuoc.class);
        //Thuc hien chuyen
        startActivity(iManHinhKhac);
    }
