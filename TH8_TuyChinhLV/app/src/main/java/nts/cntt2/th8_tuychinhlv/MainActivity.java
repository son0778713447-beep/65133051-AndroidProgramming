...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dsMonAn.add(new MonAn("Bún đặc biệt", 25000, "Đặc sản Nha Trang",R.drawable.bun));
        dsMonAn.add(new MonAn("Mì xào", 35000, "Mì xào trứng",R.drawable.mixao));
        dsMonAn.add(new MonAn("Salad trộn", 20000, "Đặc sản Nha Trang",R.drawable.salad));
        //
